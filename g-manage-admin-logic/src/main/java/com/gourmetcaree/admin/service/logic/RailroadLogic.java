...
import com.gourmetcaree.admin.service.property.RailroadProperty;
 ...
 *
 */
public class RailroadLogic extends AbstractAdminLogic {
	 ...
	 * @return WEBデータ路線図DTO
	 */
	public RailroadDto getRouteName(RailroadProperty property) {
