...
@Entity
@Table(name = "t_web")
public class TWeb extends AbstractCommonEntity {

    /**
     * シリアルバージョンUID
     */
    private static final long serialVersionUID = 2898790791151452342L;

    /**
     * ID
     */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "t_web_id_gen")
    @SequenceGenerator(name = "t_web_id_gen", sequenceName = "t_web_id_seq", allocationSize = 1)
    @Column(name = "id")
    public Integer id;
     ...
     * 注目店舗名
     */
    @Column(name = "attention_shop_name")
     ...
     * フォトアルバム表示フラグ
     */
    @Column(name = "photo_album_display_flg")
    public Integer photoAlbumDisplayFlg;

    /**
     * 店舗情報表示フラグ
     */
    @Column(name = "shop_information_display_flg")
    public Integer shopInformationDisplayFlg;

    /**
     * 店舗データ表示フラグ
     */
    @Column(name = "shop_data_display_flg")
    public Integer shopDataDisplayFlg;
    ...
    /** 求人一覧動画表示フラグ */
    @Column(name = "movie_list_display_flg")
    public Integer movieListDisplayFlg;

    /** 求人詳細動画表示フラグ */
    @Column(name = "movie_detail_display_flg")
    public Integer movieDetailDisplayFlg;
    ...
    /** リニューアルフラグ */
    @Column(name = "renewal_flg")
    public Integer renewalFlg;

    /** リニューアル2フラグ */
    @Column(name = "renewal2_flg")
    public Integer renewal2Flg = MTypeConstants.Renewal2Flg.TARGET;

    /** MT記事ID */
    @Column(name = "mt_blog_id")
    public Integer mtBlogId;

    /** 検索対象フラグ */
    @Column(name = "search_target_flg")
    public Integer searchTargetFlg;

    /** 検索優先フラグ */
    @Column(name = "search_preferential_flg")
    public Integer searchPreferentialFlg;

    /** ピックアップ開始日 */
    @Temporal(TemporalType.TIMESTAMP)
    @Column(name = "attention_shop_start_date")
    public Date attentionShopStartDate;

    /** ピックアップ終了日 */
    @Temporal(TemporalType.TIMESTAMP)
    @Column(name = "attention_shop_end_date")
    public Date attentionShopEndDate;

    /** 検索優先開始日 */
    @Temporal(TemporalType.TIMESTAMP)
    @Column(name = "search_preferential_start_date")
    public Date searchPreferentialStartDate;

    /** 検索優先終了日 */
    @Temporal(TemporalType.TIMESTAMP)
    @Column(name = "search_preferential_end_date")
    public Date searchPreferentialEndDate;

    /** 連載 */
    @Column(name="serial_publication")
    public String serialPublication;

    /**
     * WEBデータ属性のリスト
     */
    @OneToMany(mappedBy = "tWeb")
    public List<TWebAttribute> tWebAttributeList;

    /**
     * WEBデータ路線図のリスト
     */
    @OneToMany(mappedBy = "tWeb")
    public List<TWebRoute> tWebRouteList;

    /**
     * WEBデータ特集のリスト
     */
    @OneToMany(mappedBy = "tWeb")
    public List<TWebSpecial> tWebSpecialList;

    /**
     * 素材のリスト
     */
    @OneToMany(mappedBy = "tWeb")
    public List<TMaterial> tMaterialList;
     ...
     */
    @OneToMany(mappedBy = "tWeb")
    public List<TWebJob> tWebJobList;

    /**
     * WEBデータ職種のリスト
     */
    @OneToOne(mappedBy = "tWeb")
    public TWebSearch tWebSearch;

    /**
     * テーブル名
     */
    public static final String TABLE_NAME = "t_web";
     ...
     * 注目店舗名
     */
    public static final String ATTENTION_SHOP_NAME = "attention_shop_name";

    /**
     * 注目店舗文章
     */
    public static final String ATTENTION_SHOP_SENTENCE = "attention_shop_sentence";
     ...
     * フォトアルバム表示フラグ
     */
    public static final String PHOTO_ALBUM_DISPLAY_FLG = "photo_album_display_flg";

    /**
     * 店舗情報表示フラグ
     */
    public static final String SHOP_INFORMATION_DISPLAY_FLG = "shop_information_display_flg";

    /**
     * 店舗データ表示フラグ
     */
    public static final String SHOP_DATA_DISPLAY_FLG = "shop_data_display_flg";

    /**
     * WEBデータ属性のリスト
     */
    public static final String T_WEB_ATTRIBUTE_LIST = "t_web_attribute_list";

    /**
     * WEBデータ路線図のリスト
     */
    public static final String T_WEB_ROUTE_LIST = "t_web_route_list";

    /**
     * WEBデータ特集のリスト
     */
    public static final String T_WEB_SPECIAL_LIST = "t_web_special_list";

    /**
     * 素材のリスト
     */
    public static final String T_MATERIAL_LIST = "t_material_list";
    ...
    /** 求人一覧動画表示フラグ */
    public static final String MOVIE_LIST_DISPLAY_FLG = "movie_list_display_flg";

    /** 求人詳細動画表示フラグ */
    public static final String MOVIE_DETAIL_DISPLAY_FLG = "movie_detail_display_flg";
    ...
    /** リニューアル2フラグ */
    public static final String RENEWAL2_FLG = "renewal2_flg";

    /** MT記事ID */
    public static final String MT_BLOG_ID = "mt_blog_id";

    /** 検索対象フラグ */
    public static final String SEARCH_TARGET_FLG = "search_target_flg";

    /** 検索優先フラグ */
    public static final String SEARCH_PREFERENTIAL_FLG  = "search_preferential_flg";

    /** ピックアップ開始日 */
    public static final String ATTENTION_SHOP_START_DATE = "attention_shop_start_date";

    /** ピックアップ終了日 */
    public static final String ATTENTION_SHOP_END_DATE = "attention_shop_end_date";

    /** 検索優先開始日 */
    public static final String SEARCH_PREFERENTIAL_START_DATE = "attention_shop_start_date";

    /** 検索優先終了日 */
    public static final String SEARCH_PREFERENTIAL_END_DATE = "search_preferential_end_date";

    /** 連載 */
    public static final String SERIAL_PUBLICATION = "serial_publication";
     ...
     * 号数マスタ
     */
    public static final String M_VOLUME = "m_volume";

    /**
     * WEBデータ職種のリスト
     */
    public static final String T_WEB_JOB_LIST = "t_web_job_list";
