...
/**
 * ジャスキル会員一覧のVIEWのエンティティクラスです。
 * @version 1.0
 */
@Entity
@Table(name="v_juskill_member_list")
public class VJuskillMemberList extends AbstractCommonEntity implements Serializable {

    /** シリアルバージョンUID */
	private static final long serialVersionUID = 8828563293551572930L;
	...
	/** ジャスキル会員職歴エンティティリスト */
	@OneToMany(mappedBy = "vJuskillMember")
	...
	@OneToMany(mappedBy = "vJuskillMember")
	public List<TJuskillMemberMaterial> tJuskillMemberMaterial;
	public static final String T_JUSKILL_MEMBER_MATERIAL = "tJuskillMemberMaterial";

    /** テーブル名 */
    public static final String TABLE_NAME = "v_juskill_member_list";
	/** ID */
    ...
    /** スペースを除いた名前 */
    public static final String TRIM_NAME = "trim_name";
