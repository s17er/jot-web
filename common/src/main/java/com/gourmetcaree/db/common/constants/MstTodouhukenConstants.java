...
public class MstTodouhukenConstants {
    ...
    public static final int GUNMA = 10;
    ...
    public static final int KOCHI = 39;
    ...
    public static final int OITA = 44;
    public static final int MIYAZAKI = 45;
    public static final int KAGOSHIMA = 46;
    public static final int OKINAWA = 47;


    public static List<Integer> getDisplayList(int areaCd) {
        if (MAreaConstants.AreaCd.isSendai(areaCd)) {
            return getSendaiDisplayList();
        }

        return Collections.emptyList();
    }

    public static List<Integer> getSendaiDisplayList() {
        List<Integer> list = Lists.newArrayList();
        for (MArbeitConstants.SendaiSiteEnum val : MArbeitConstants.SendaiSiteEnum.values()) {
            list.add(Integer.parseInt(val.getValue()));
        }
        return list;
    }
}
