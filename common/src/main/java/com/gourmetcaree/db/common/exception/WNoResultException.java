 ...
 * @version 1.0
 */
public class WNoResultException extends Exception {
	 ...
	 * @param message
	 */
	public WNoResultException(String message) {
		super(message);
	}
	 ...
	 * @param cause
	 */
	public WNoResultException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause
	 */
	public WNoResultException(Throwable cause) {
		super(cause);
	}
}
