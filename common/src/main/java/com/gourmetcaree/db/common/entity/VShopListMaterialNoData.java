 ...
 */
@Entity
@Table(name="v_shop_list_material_no_data")
public class VShopListMaterialNoData implements Serializable {
	...
	/** テーブル名 */
	public static final String TABLE_NAME = "v_shop_list_material_no_data";
