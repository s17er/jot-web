 ...
 */
@Entity
@Table(name="v_web_list")
public class VWebList extends AbstractBaseEntity implements Serializable, PublicationEndAccessor {

	/** シリアルバージョンUID */
	private static final long serialVersionUID = 1131823396674385242L;
	...
	/** テーブル名 */
	public static final String TABLE_NAME = "v_web_list";
	...
	@Override
	public Integer getPublicationEndDisplayFlg() {
		return publicationEndDisplayFlg;
	}
	...
	@Override
	public Date getPostStartDatetime() {
		return postStartDatetime;
	}

	@Override
	public Date getPostEndDatetime() {
		return postEndDatetime;
	}


	/**
	 * 掲載が終了しているかどうか
	 * @return 掲載が終了している場合はtrue
	 */
	public boolean isPublicationEnd() {
		if (status == null) {
			return true;
		}

		if (MStatusConstants.DisplayStatusCd.POST_END.equals(status)) {
			return true;
		}

		if (postEndDatetime == null) {
			return true;
		}

		return postEndDatetime.before(new Date());
	}
}