...
/**
 * 鉄道会社マスタの全データのラベルとバリューが格納されたリストをページコンテキストに設定します。
 * @author Makoto Otani
 * @version 1.0
 */
public class RailroadAllListTag extends TagSupport {

	/** シリアルバージョンUID */
	private static final long serialVersionUID = 3615092581459241089L;
	...
	public int doEndTag() throws JspException {
		...
		Method method = ClassUtil.getMethod(clazz, "getRailroadAllList", argsClass);
