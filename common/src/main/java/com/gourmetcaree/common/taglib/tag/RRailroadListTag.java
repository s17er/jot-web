...
/**
 * リニューアル後の鉄道会社マスタのラベルとバリューが格納されたリストをページコンテキストに設定します。
 * @version 1.0
 */
public class RRailroadListTag extends TagSupport {
	...
	public int doEndTag() throws JspException {
		...
		Method method = ClassUtil.getMethod(clazz, "getRRailroadList", argsClass);
