...
/**
 * 営業担当者マスタのラベルとバリューが格納されたリストをページコンテキストに設定します。
 * @author Katsutoshi Hasegawa
 * @version 1.0
 */
public class SalesListTag extends TagSupport {


	/** シリアルバージョンUID */
	private static final long serialVersionUID = 6519004140331203724L;
	...
	public int doEndTag() throws JspException {
		...
		Method method = ClassUtil.getMethod(clazz, "getSalesList", argsClass);
