 ...
 * @version 1.0
 */
public class AssignedSalesListTag extends TagSupport {


	/** シリアルバージョンUID */
	private static final long serialVersionUID = -5870720079661227586L;
	...
	public int doEndTag() throws JspException {
		...
		Method method = ClassUtil.getMethod(clazz, "getAssignedSalesList", argsClass);
