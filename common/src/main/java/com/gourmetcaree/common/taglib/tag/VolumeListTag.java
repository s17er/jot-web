 ...
 * @version 1.0
 */
public class VolumeListTag extends TagSupport {


	/** シリアルバージョンUID */
	private static final long serialVersionUID = -8062929740375916935L;
	...
	public int doEndTag() throws JspException {
		...
		Method method = ClassUtil.getMethod(clazz, "getVolumeList", argsClass);
