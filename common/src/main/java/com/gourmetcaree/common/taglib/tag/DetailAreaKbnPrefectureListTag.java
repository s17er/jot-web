...
/**
 * 都道府県ごとにWebAreaDetail区分のリストを生成するタグ
 */
public class DetailAreaKbnPrefectureListTag extends BaseTagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        List<TypePrefectureInfo> list = logic.selectDetailAreaKbnPrefectures(Utils.toObjectToInt(areaCd, 0));
