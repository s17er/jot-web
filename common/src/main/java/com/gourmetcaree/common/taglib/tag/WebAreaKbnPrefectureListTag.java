...
/**
 * 都道府県ごとにWebArea区分のリストを生成するタグ
 */
public class WebAreaKbnPrefectureListTag extends BaseTagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        List<TypePrefectureInfo> list = logic.selectWebAreaKbnPrefectures(Utils.toObjectToInt(areaCd, 0));
