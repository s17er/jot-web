...
public class CompanyListTag extends TagSupport {
	...
	/** シリアルバージョンUID */
	private static final long serialVersionUID = -4588669879114157222L;
	...
	public int doEndTag() throws JspException {
		...
		Method method = ClassUtil.getMethod(clazz, "getCompanyList", argsClass);
