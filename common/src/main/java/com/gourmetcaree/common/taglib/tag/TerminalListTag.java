...
/**
 * ターミナルのラベルとバリューが格納されたリストをページコンテキストに設定します。
 * @version 1.0
 */
public class TerminalListTag extends TagSupport {
	...
	public int doEndTag() throws JspException {
		...
		Method method = ClassUtil.getMethod(clazz, "getTerminalList", argsClass);
