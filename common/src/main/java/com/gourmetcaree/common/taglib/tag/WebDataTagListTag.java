...
/**
 * WEBデータ用に登録されたタグリストをページコンテキストに設定します。
 * @author kyamane
 * @version 1.0
 */
public class WebDataTagListTag extends TagSupport {


	/** シリアルバージョンUID */
	private static final long serialVersionUID = 2409607125678452005L;
	...
	public int doEndTag() throws JspException {
		...
		Class<?>[] argsClass = {String.class, String.class, String.class, List.class};
		Method method = ClassUtil.getMethod(clazz, "getWebDataTagList", argsClass);

		Object[] args = new Object[4];
		args[0] = (String)blankLineLabel;
		args[1] = (String)suffix;
		args[2] = (String)authLevel;
		args[3] = (List<Integer>)noDisplayValue;
