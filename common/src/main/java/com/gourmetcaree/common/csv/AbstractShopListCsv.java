...
public class AbstractShopListCsv {
	...
	@CSVColumn(columnIndex=23, columnName="ロゴ画像")
	public String logoImg;

	@CSVColumn(columnIndex=24, columnName="画像名")
	public String mainImg;

	@CSVColumn(columnIndex=25, columnName="受動喫煙対策")
	public String preventSmoke;

	@CSVColumn(columnIndex=26, columnName="国内外")
	public String domesticKbn;

	@CSVColumn(columnIndex=27, columnName="海外エリア")
	public String shutokenForeignAreaKbn;

	@CSVColumn(columnIndex=28, columnName="海外住所")
	public String foreignAddress;

	@CSVColumn(columnIndex=29, columnName="都道府県コード")
	public String prefecturesCd;

	@CSVColumn(columnIndex=30, columnName="市区コード")
	public String cityCd;

	@CSVColumn(columnIndex=31, columnName="その他住所")
