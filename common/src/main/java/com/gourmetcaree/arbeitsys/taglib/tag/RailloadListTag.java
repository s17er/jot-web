...
public class RailloadListTag extends TagSupport {
	...
	/** シリアルバージョンUID */
	private static final long serialVersionUID = 9020827923375624848L;
	...
	public int doEndTag() throws JspException {
		...
		Class<?>[] argClass = {String.class, String.class, int.class};
		Object[] args = new Object[]{blankLineLabel, suffix, pref};
