 ...
 *
 */
public class ArbeitAreaListTag extends TagSupport {

	/** シリアルバージョンUID */
	private static final long serialVersionUID = 8416341576715694588L;
	...
	public int doEndTag() throws JspException {
		...
		Object[] args = new Object[]{todouhukenId, blankLineLabel, suffix};

		Method method = ClassUtil.getMethod(clazz, "getAreaList", argClass);
