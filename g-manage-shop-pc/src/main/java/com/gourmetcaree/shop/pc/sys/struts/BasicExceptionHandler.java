package com.gourmetcaree.shop.pc.sys.struts;
...
import jp.co.whizz_tech.common.web.log.ServletContextLogBuilder;
...
public class BasicExceptionHandler extends ExceptionHandler {
	...
	public ActionForward execute(Exception ex, ExceptionConfig ae,
		...
		logHelper.addLogBuilder(new ServletContextLogBuilder(ServletContextUtil.getServletContext()));
