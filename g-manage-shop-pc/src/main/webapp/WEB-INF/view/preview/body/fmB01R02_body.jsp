...
<c:set var="MAIN3_IMG_PATH" value="${gf:makePathConcat2Arg('/util/imageUtility/displayImage', id, MATERIAL_KBN_MAIN3)}" scope="page" />
	...
	<c:when test="${previewMethodKbn eq ENUM_DRAFT_PREVIEW }">
		<c:set var="DETAIL3_PATH" value="${gf:makePathConcat3Arg('/detailPreview/mobileDraftDetail/displayDetail3', id, accessCd, areaCd)}" scope="page" />
	...
	<c:otherwise>
		<c:set var="DETAIL3_PATH" value="${gf:makePathConcat1Arg('/detailPreview/mobileDetail/displayDetail3', id)}#bosyu" scope="page" />
