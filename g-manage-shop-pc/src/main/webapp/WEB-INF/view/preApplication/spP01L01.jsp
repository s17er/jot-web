...
<tiles:insert template="/WEB-INF/view/common/shopLayout.jsp" flush="false">
	...
	<tiles:put name="content" value="/WEB-INF/view/preApplication/body/spP01_list_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="list" />
	<tiles:put name="actionPath" value="/preApplication/list" />
	<tiles:put name="actionLumpSendPath" value="/preApplication/list/lumpSend" />
	<tiles:put name="pageTitle" value="プレ応募者一覧" />
	<tiles:put name="pageTitleId" value="entryList" />
	...
	<tiles:put name="pageNaviPath" value="/preApplication/list/changePage/" />
</tiles:insert>