...
<tiles:insert template="/WEB-INF/view/common/shopLayout.jsp" flush="false">
	<tiles:put name="title" value="定型文の編集完了 | グルメキャリー 顧客管理画面"/>
	...
	<tiles:put name="pageTitle" value="定型文の編集完了" />
	<tiles:put name="pageTitleId" value="patternEditComp" />
	<tiles:put name="defaultMsg" value="定型文を編集しました。"/>
</tiles:insert>