...
<tiles:insert template="/WEB-INF/view/common/commonLayout.jsp" flush="false">
	...
	<tiles:put name="content" value="/WEB-INF/view/masquerade/login/body/spB01_login_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="" />
	<tiles:put name="actionPath" value="/masquerade/login/login/login" />
	<tiles:put name="pageTitle" value="なりすましログイン" />
