...
<tiles:insert template="/WEB-INF/view/common/shopLayout.jsp" flush="false">
	...
	<tiles:put name="content" value="/WEB-INF/view/application/body/spC01_detail_list_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="list" />
	<tiles:put name="actionPath" value="/application/detailMailList/" />
	<tiles:put name="pageTitle" value="応募者履歴" />
	...
	<tiles:put name="pageNaviPath" value="/application/detailMailList/changePage" />
</tiles:insert>