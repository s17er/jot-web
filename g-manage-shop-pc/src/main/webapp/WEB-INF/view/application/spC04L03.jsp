...
<tiles:insert template="/WEB-INF/view/common/shopLayout.jsp" flush="false">
	...
	<tiles:put name="content" value="/WEB-INF/view/application/body/spC04_detail_list_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="list" />
	<tiles:put name="actionPath" value="/observateApplication/detailMailList/" />
	<tiles:put name="pageTitle" value="質問メール一覧" />
	<tiles:put name="pageTitleId" value="questionHistory" />
