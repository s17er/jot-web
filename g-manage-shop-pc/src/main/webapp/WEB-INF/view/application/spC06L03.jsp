...
<tiles:insert template="/WEB-INF/view/common/shopLayout.jsp" flush="false">
	...
	<tiles:put name="content" value="/WEB-INF/view/application/body/spC06_detail_list_body.jsp" />
	...
	<tiles:put name="pageTitleId" value="scoutHistory" />
	...
	<tiles:put name="pageNaviPath" value="/scoutMember/detailMailList/changePage" />
