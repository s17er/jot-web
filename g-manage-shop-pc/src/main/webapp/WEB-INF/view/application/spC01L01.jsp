...
<tiles:insert template="/WEB-INF/view/common/shopLayout.jsp" flush="false">
	...
	<tiles:put name="content" value="/WEB-INF/view/application/body/spC01_list_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="list" />
	<tiles:put name="actionPath" value="/application/list" />
	<tiles:put name="actionLumpSendPath" value="/application/list/lumpSend" />
	...
	<tiles:put name="pageNaviPath" value="/application/list/changePage/" />
</tiles:insert>