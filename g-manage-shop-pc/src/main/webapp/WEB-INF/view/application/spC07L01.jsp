...
<tiles:insert template="/WEB-INF/view/common/shopLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 気になる送受信者一覧画面"/>
	<tiles:put name="content" value="/WEB-INF/view/application/body/spC07_list_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="list" />
	<tiles:put name="actionPath" value="/scoutMember/list" />
	<tiles:put name="pageTitle" value="気になる通知一覧" />
	<tiles:put name="pageTitleId" value="interestList" />
