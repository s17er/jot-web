...
<head>
	...
	<script type="text/javascript" src="${f:h(frontHttpUrl)}/js/jquery/jquery.js"></script>
...
<body>
	<tiles:insert page="/WEB-INF/view/preview/include/checkStatusChange.jsp"></tiles:insert>
	<!-- #all# -->
	<div id="all">
		<% /* タイルズ：ヘッダーメニュー部 */ %>
