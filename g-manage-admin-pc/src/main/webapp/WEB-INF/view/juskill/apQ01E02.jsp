...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 人材紹介登録者編集確認"/>
	...
	<tiles:put name="pageTitle1" value="人材紹介登録者編集確認" />
	<tiles:put name="pageTitleId1" value="title_juskillMemberEditConf" />
