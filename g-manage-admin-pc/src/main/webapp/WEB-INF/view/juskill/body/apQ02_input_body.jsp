			...
			<tr>
				<td>
					...
					<c:if test="${!empty whereMap[MEMBER_REGISTERED_FLG]}">
						<gt:typeList name="memberRegisteredList" typeCd="<%=MTypeConstants.MemberRegisteredFlg.TYPE_CD %>" />
						<span class="attention">会員登録：</span>
						${f:label(whereMap[MEMBER_REGISTERED_FLG], memberRegisteredList, 'value', 'label')}&nbsp;&nbsp;
					</c:if>
		...
		<s:form action="${f:h(actionPath)}">
			<table cellpadding="0" cellspacing="0" border="0" class="cmn_table detail_table btm_margin">
				...
				<tr>
					...
					<td><html:text property="pcMailMagazineTitle" /></td>
				</tr>
				<tr>
					<th class="bdrs_bottom">本文&nbsp;<span class="attention">※必須</span></th>
					<td class="bdrs_bottom"><html:textarea property="pcBody" cols="60" rows="10"></html:textarea></td>
				</tr>
			</table>
			<hr />
...
<!-- 				<tr> -->
<!-- 					<th width="150">タイトル&nbsp;<span class="attention">※必須</span></th> -->
<%-- 					<td><html:text property="mbMailMagazineTitle" /></td> --%>
<!-- 				</tr> -->
<!-- 				<tr> -->
<!-- 					<th class="bdrs_bottom">本文&nbsp;<span class="attention">※必須</span></th> -->
<%-- 					<td class="bdrs_bottom"><html:textarea property="mbBody" cols="60" rows="10"></html:textarea></td> --%>
<!-- 				</tr> -->
<!-- 			</table> -->
<!-- 			<hr /> -->
