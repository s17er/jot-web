...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | いたずら応募条件削除完了"/>
	<tiles:put name="content" value="/WEB-INF/view/maintenance/body/apJ_comp_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="${PAGE_DELETE}" />
	<tiles:put name="actionPath" value="/mischief/delete/" />
	<tiles:put name="pageTitle1" value="いたずら応募条件削除完了" />
	<tiles:put name="pageTitleId1" value="title_mischiefApplicationConditionDelComp" />
