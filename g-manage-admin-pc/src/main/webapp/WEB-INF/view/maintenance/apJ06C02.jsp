...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 事前登録の開催年登録確認"/>
	...
	<tiles:put name="actionBackPath" value="/advancedRegistration/input/corret" />
	<tiles:put name="pageTitle1" value="事前登録の開催年登録確認" />
	<tiles:put name="pageTitleId1" value="title_fairDataInputConf" />
