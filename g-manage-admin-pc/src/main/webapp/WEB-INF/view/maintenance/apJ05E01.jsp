...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 会社編集"/>
	<tiles:put name="content" value="/WEB-INF/view/maintenance/body/apJ05_input_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="${PAGE_EDIT}" />
	<tiles:put name="actionPath" value="/company/edit/" />
	<tiles:put name="pageTitle1" value="会社編集" />
	<tiles:put name="pageTitleId1" value="title_companyEdit" />
