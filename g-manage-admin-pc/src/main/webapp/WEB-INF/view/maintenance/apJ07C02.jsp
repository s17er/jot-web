...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 事前登録の開催年編集確認"/>
	...
	<tiles:put name="actionBackPath" value="/advancedRegistration/edit/corret" />
	<tiles:put name="pageTitle1" value="事前登録の開催年編集確認" />
	<tiles:put name="pageTitleId1" value="title_fairDataEditConf" />
