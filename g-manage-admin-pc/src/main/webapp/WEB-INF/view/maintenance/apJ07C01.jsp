...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 事前登録の開催年編集"/>
	...
	<tiles:put name="actionListPath" value="/advancedRegistration/list/" />
	<tiles:put name="pageTitle1" value="事前登録の開催年編集" />
	<tiles:put name="pageTitleId1" value="title_fairDataEdit" />
