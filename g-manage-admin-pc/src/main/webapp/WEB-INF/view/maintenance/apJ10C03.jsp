...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | いたずら応募条件の登録完了"/>
	...
	<tiles:put name="pageTitle1" value="いたずら応募条件の登録完了" />
	<tiles:put name="pageTitleId1" value="title_mischiefApplicationConditionDataInputComp" />
	...
	<tiles:put name="navigationPath3" value="/mischief/input/" />
