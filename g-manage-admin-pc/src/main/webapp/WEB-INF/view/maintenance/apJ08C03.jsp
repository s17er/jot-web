...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 駅グループの登録完了"/>
	...
	<tiles:put name="pageTitle1" value="駅グループの登録完了" />
	<tiles:put name="pageTitleId1" value="title_terminalDataInputComp" />
	...
	<tiles:put name="navigationPath3" value="/terminal/input/" />
