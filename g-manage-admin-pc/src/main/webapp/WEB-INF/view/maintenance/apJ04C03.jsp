...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 営業担当者登録完了"/>
	...
	<tiles:put name="pageTitle1" value="営業担当者登録完了" />
	<tiles:put name="pageTitleId1" value="title_salesInputComp" />
	...
	<tiles:put name="navigationPath3" value="/sales/input/index" />
