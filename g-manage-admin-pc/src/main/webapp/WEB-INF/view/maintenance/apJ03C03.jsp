...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 特集データ登録完了"/>
	...
	<tiles:put name="pageTitle1" value="特集データ登録完了" />
	<tiles:put name="pageTitleId1" value="title_specialInputComp" />
	...
	<tiles:put name="navigationPath3" value="/special/input/index" />
