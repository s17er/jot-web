...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 会社一覧"/>
	<tiles:put name="content" value="/WEB-INF/view/maintenance/body/apJ05_list_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="${PAGE_LIST}" />
	<tiles:put name="actionPath" value="/company/list/" />
	<tiles:put name="pageTitle1" value="会社一覧" />
