	...
	<div class="wrap_search">
		<s:form action="${f:h(actionPath)}">
			...
			<table cellpadding="0" cellspacing="1" border="0" class="search_table">
				...
				<tr>
					<th>応募ID</th>
					<td class="release"><html:text property="where_applicationId" size="10" styleClass="disabled" /></td>
					<th>会員登録</th>
					<td>
	...
	<!-- #wrap_result# -->
		...
		<table cellpadding="0" cellspacing="0" border="0" class="page">
			...
			<c:if test="${dto.linkFlg eq true}">
				...
				<c:set var="pageLinkPath" scope="page" value="/application/list/changePage/${dto.pageNum}" />
		...
		<table cellpadding="0" cellspacing="0" border="0" class="cmn_table list_table">
			...
			<c:set var="classStr" value="${gf:odd(status.index, 'blue', '')}" scope="page" />
				...
				<tr>
					...
					<td class="${classStr}"><c:if test="${userDto.authLevel eq AUTH_LEVEL_ADMIN or userDto.authLevel eq AUTH_LEVEL_SALES}">${f:h(dto.name)}&nbsp;</c:if>&nbsp;</td>
