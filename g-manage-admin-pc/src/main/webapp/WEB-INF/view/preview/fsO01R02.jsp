...
<tiles:insert template="/WEB-INF/view/common/frontSmartDetailLayout.jsp" flush="false">
	...
	<tiles:put name="head" value="/WEB-INF/view/preview/smart/shopDetailMsgHead.jsp" />
	<tiles:put name="header" value="/WEB-INF/view/preview/smart/detailHeader.jsp" />
	<tiles:put name="content" value="/WEB-INF/view/preview/body/fsO01R02_body.jsp" />
	<%// TODO 違うやつ %>
	<tiles:put name="footer" value="/WEB-INF/view/preview/smart/shopDetailMsgFooter.jsp" />
	...
	<tiles:put name="messagePageFlg" value="${true}" />
</tiles:insert>