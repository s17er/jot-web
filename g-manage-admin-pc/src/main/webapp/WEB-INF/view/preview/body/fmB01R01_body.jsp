...
<c:set var="OBSERVATION_KBN_QUESTION_OBSERVATION" value="<%=MTypeConstants.ObservationKbn.ADMIN_QUESTION_OBSERVATION%>" scope="page" />
	...
	<c:when test="${imgMethodKbn eq ENUM_IMG_METHOD_KBN_SESSION }">
		<c:set var="DETAIL2_PATH" value="${gf:makePathConcat2Arg('/detailPreview/mobileDetail/displayDetail2', id, inputFormKbn)}#bosyu" scope="page" />
		<c:set var="KINMUCHI_PATH" value="${gf:makePathConcat2Arg('/detailPreview/mobileDetail/displayCompany', id, inputFormKbn)}#shop" scope="page" />
		<c:set var="MAP_PATH" value="${gf:makePathConcat2Arg('/detailPreview/mobileDetail/displayMap', id, inputFormKbn)}" scope="page" />
	</c:when>
	<c:otherwise>
		<c:set var="DETAIL2_PATH" value="${gf:makePathConcat1Arg('/detailPreview/mobileDbDetail/displayDetail2', id)}#bosyu" scope="page" />
		<c:set var="KINMUCHI_PATH" value="${gf:makePathConcat1Arg('/detailPreview/mobileDbDetail/displayCompany', id)}#shop" scope="page" />
