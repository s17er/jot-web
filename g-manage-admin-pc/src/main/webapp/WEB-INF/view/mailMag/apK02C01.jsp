...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | メルマガヘッダメッセージ登録"/>
	<tiles:put name="content" value="/WEB-INF/view/mailMag/body/apK02_input_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="${PAGE_INPUT}" />
	<tiles:put name="actionPath" value="/mailMagOption/headerInput/" />
	<tiles:put name="pageTitle1" value="メルマガヘッダメッセージ登録" />
	...
	<tiles:put name="upImageAjaxPath" value="/mailMagOption/headerInput/upAjaxMaterial" />
