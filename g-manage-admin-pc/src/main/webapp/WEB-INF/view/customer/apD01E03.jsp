...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 顧客データ編集完了"/>
	...
	<tiles:put name="pageTitle1" value="顧客データ編集完了" />
	<tiles:put name="pageTitleId1" value="title_customerEditComp" />
	...
	<tiles:put name="navigationText3" value="顧客詳細一覧へ" />
