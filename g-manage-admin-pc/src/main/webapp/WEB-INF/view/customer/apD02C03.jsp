...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 顧客向けメルマガ登録完了"/>
	...
	<tiles:put name="pageTitle1" value="顧客向けメルマガ登録完了" />
	<tiles:put name="pageTitleId1" value="title_customerMailMagInputComp" />
