...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | ラベル編集"/>
	<tiles:put name="content" value="/WEB-INF/view/shopList/body/apQ06_input_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="${PAGE_INPUT}" />
	<tiles:put name="actionPath" value="/shopLabel/edit/" />
	<tiles:put name="pageTitle1" value="ラベル登録店舗の選択" />
