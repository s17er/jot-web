...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | ${f:h(LABEL_SHOPLIST)}登録画面"/>
	<tiles:put name="content" value="/WEB-INF/view/shopList/body/apQ01_input_body.jsp" />
	...
	<tiles:put name="navigationPath2" value="/shopList/inputCsv/backToIndex" />
	...
	<tiles:put name="upImgAjaxPath" value="/shopList/inputCsv/upAjaxMaterial" />
	<tiles:put name="delImgAjaxPath" value="/shopList/inputCsv/delAjaxMaterial" />
</tiles:insert>