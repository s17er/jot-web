...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	...
	<tiles:put name="content" value="/WEB-INF/view/shopList/body/apQ07_list_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="${PAGE_OTHER}" />
	<tiles:put name="actionPath" value="/shopList/inputJobCsv/" />
	...
	<tiles:put name="navigationPath2" value="/shopList/inputJobCsv/backToIndex" />
