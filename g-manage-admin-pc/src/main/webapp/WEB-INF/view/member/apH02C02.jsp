...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 会員向けメルマガ登録確認"/>
	<tiles:put name="content" value="/WEB-INF/view/member/body/apH02_conf_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="${PAGE_INPUT}" />
	<tiles:put name="actionPath" value="/memberMailMag/input/" />
	<tiles:put name="pageTitle1" value="会員向けメルマガ登録確認" />
	<tiles:put name="pageTitleId1" value="title_memberMailMagInputConf" />
