...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 会員データ詳細"/>
	...
	<tiles:put name="pageTitle1" value="会員データ詳細" />
	<tiles:put name="pageTitleId1" value="title_memberDetail" />
	<tiles:put name="navigationText1" value="管理画面トップへ" />
	<tiles:put name="navigationPath1" value="/top/menu/" />
	<tiles:put name="navigationText2" value="会員データ一覧へ" />
	<tiles:put name="navigationPath2" value="/member/list/" />
	<tiles:put name="navigationText3" value="気になるデータ一覧へ" />
	<tiles:put name="navigationPath3" value="/interest/list/" />
