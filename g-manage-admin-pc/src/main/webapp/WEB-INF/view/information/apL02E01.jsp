...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 運営側お知らせ編集"/>
	<tiles:put name="content" value="/WEB-INF/view/information/body/apL_input_body.jsp" />
	...
	<c:when test="${managementScreenKbn eq ADMIN_SCREEN}">
		...
		<tiles:put name="pageTitle1" value="運営側お知らせ編集" />
		<tiles:put name="pageTitleId1" value="title_adminInformationEdit" />
	...
	<c:when test="${managementScreenKbn eq SHOP_SCREEN}">
		<tiles:put name="actionPath" value="/manageInfo/edit/" />
		<tiles:put name="pageTitle1" value="店舗側お知らせ編集" />
		<tiles:put name="pageTitleId1" value="title_shopInformationEdit" />
		<tiles:put name="navigationText1" value="管理画面トップへ" />
		<tiles:put name="navigationPath1" value="/top/menu/" />
		<tiles:put name="navigationText2" value="お知らせ管理メニューへ" />
		<tiles:put name="navigationPath2" value="/information/menu/" />
	...
	<c:when test="${managementScreenKbn eq MY_PAGE_SCREEN}">
		<tiles:put name="actionPath" value="/manageInfo/edit/" />
		<tiles:put name="pageTitle1" value="Myページお知らせ編集" />
		<tiles:put name="pageTitleId1" value="title_mypageInformationEdit" />
		<tiles:put name="navigationText1" value="管理画面トップへ" />
		<tiles:put name="navigationPath1" value="/top/menu/" />
		<tiles:put name="navigationText2" value="お知らせ管理メニューへ" />
		<tiles:put name="navigationPath2" value="/information/menu/" />
