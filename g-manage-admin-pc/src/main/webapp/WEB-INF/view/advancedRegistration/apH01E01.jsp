...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 合同企業説明会エントリーデータ編集"/>
	<tiles:put name="content" value="/WEB-INF/view/advancedRegistration/body/apH01_input_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="${PAGE_EDIT}" />
	<tiles:put name="actionPath" value="/advancedRegistrationMember/edit/" />
	<tiles:put name="pageTitle1" value="合同企業説明会エントリーデータ編集" />
	<tiles:put name="pageTitleId1" value="title_advancedMemberEdit" />
