...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 合同企業説明会エントリーデータ詳細"/>
	...
	<tiles:put name="actionPath" value="/advancedRegistrationMember/detail/" />
	<tiles:put name="pageTitle1" value="合同企業説明会エントリーデータ詳細" />
	<tiles:put name="pageTitleId1" value="title_advancedMemberDetail" />
