...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 合同説明会会員向けメルマガ登録"/>
	<tiles:put name="content" value="/WEB-INF/view/advancedRegistration/body/apH03_input_body.jsp" />

	<% // 以下ページ切り替え用パラメータ %>
	<tiles:put name="pageKbn" value="${PAGE_INPUT}" />
	<tiles:put name="actionPath" value="/advancedRegistrationMemberMailMag/input/" />
	<tiles:put name="pageTitle1" value="合同説明会会員向けメルマガ登録" />
