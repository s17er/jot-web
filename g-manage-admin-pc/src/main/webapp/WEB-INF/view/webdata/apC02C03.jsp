...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 応募テストデータ登録完了"/>
	...
	<tiles:put name="pageTitle1" value="応募テストデータ登録完了" />
	<tiles:put name="pageTitleId1" value="title_applicationTestInputComp" />
