...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | WEBデータ一括コピー完了"/>
	...
	<tiles:put name="pageTitle1" value="WEBデータ一括コピー完了" />
	<tiles:put name="pageTitleId1" value="title_webdataLumpCopyComp" />
