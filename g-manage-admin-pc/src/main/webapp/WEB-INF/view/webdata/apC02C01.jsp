...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | 応募テストデータ登録"/>
	<tiles:put name="content" value="/WEB-INF/view/webdata/body/apC02_input_body.jsp" />
	...
	<tiles:put name="pageTitle2" value="応募テストデータ登録" />
	<tiles:put name="pageTitleId2" value="title_applicationTestInput" />
