...
<tiles:insert template="/WEB-INF/view/common/adminLayout.jsp" flush="false">
	<tiles:put name="title" value="${SITE_NAME} | WEBデータステータス変更完了"/>
	...
	<tiles:put name="pageTitle1" value="WEBデータステータス変更完了" />
	<tiles:put name="pageTitleId1" value="title_webdataStateEditComp" />
	<tiles:put name="navigationText1" value="管理画面トップへ" />
	<tiles:put name="navigationPath1" value="/top/menu/" />
	<tiles:put name="navigationText2" value="WEBデータ一覧へ" />
	<tiles:put name="navigationPath2" value="/webdata/list/" />
	<tiles:put name="defaultMsg" value="ステータスを変更しました。" />
</tiles:insert>