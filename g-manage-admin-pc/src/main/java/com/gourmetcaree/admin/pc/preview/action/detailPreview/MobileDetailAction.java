 ...
 * @version 1.0
 */
public class MobileDetailAction extends PreviewBaseAction {
	 ...
	 * @return 求人情報詳細画面
	 */
	@Execute(validator = false, urlPattern = "index/{id}/{inputFormKbn}", reset="resetForm", input=TransitionConstants.Preview.JSP_FMB01R01)
	public String index() {
		return show();
	}
	 ...
	 * @return メッセージ画面
	 */
	@Execute(validator = false, urlPattern = "displayRecruit/{id}/{inputFormKbn}", reset="resetForm", input=TransitionConstants.Preview.JSP_FMB01R01)
	 ...
	 * @return メッセージ画面
	 */
	@Execute(validator = false, urlPattern = "displayDetail2/{id}/{inputFormKbn}", reset="resetForm", input=TransitionConstants.Preview.JSP_FMB01R01)
	 ...
	 * @return メッセージ画面
	 */
	@Execute(validator = false, urlPattern = "displayDetail3/{id}/{inputFormKbn}", reset="resetForm", input=TransitionConstants.Preview.JSP_FMB01R01)
	 ...
	 * @return メッセージ画面
	 */
	@Execute(validator = false, urlPattern = "displayDetail4/{id}/{inputFormKbn}", reset="resetForm", input=TransitionConstants.Preview.JSP_FMB01R01)
	 ...
	 * @return メッセージ画面
	 */
	@Execute(validator = false, urlPattern = "displayCompany/{id}/{inputFormKbn}", reset="resetForm", input=TransitionConstants.Preview.JSP_FMB01R01)
	 ...
	 * @return 地図画面
	 */
	@Execute(validator = false, urlPattern = "displayMap/{id}/{inputFormKbn}", reset="resetForm", input=TransitionConstants.Preview.JSP_FMB01R01)
	 ...
	 * @return 動画画面
	 */
	@Execute(validator = false, urlPattern = "displayMovie/{id}/{inputFormKbn}", reset="resetForm", input=TransitionConstants.Preview.JSP_FMB01R01)
