...
import com.gourmetcaree.admin.pc.application.form.application.DetailForm;
...
public class DetailAction extends ApplicationBaseAction {
	 ...
	 * @return
	 */
	@Execute(validator = false, reset="resetForm", urlPattern = "index/{id}", input = TransitionConstants.Application.JSP_API01R01)
	...
	public String back() {
		// 確認画面へ遷移
		return TransitionConstants.Application.REDIRECT_APPLICATION_SEARCH_AGAIN;
	}
	...
	private String show() {
		...
		// 登録画面へ遷移
		return TransitionConstants.Application.JSP_API01R01;
	}
