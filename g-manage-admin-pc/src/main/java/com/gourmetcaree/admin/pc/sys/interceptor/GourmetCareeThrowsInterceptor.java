...
public class GourmetCareeThrowsInterceptor extends ThrowsInterceptor {
	...
	/**
	 * Ajaxでのセッションタイムアウト例外が発生した場合のハンドリング処理です。
	 * @param e 例外
	 * @param invocation
	 * @return 遷移先
	 */
	public String handleThrowable(AjaxTimeoutException e, MethodInvocation invocation) {
		return "/error/ajaxTimeout?redirect=true";
	}
...
//	}
	...
	public String handleThrowable(AjaxException e, MethodInvocation invocation) {
		log.warn(e);
		return null;
	}
}
