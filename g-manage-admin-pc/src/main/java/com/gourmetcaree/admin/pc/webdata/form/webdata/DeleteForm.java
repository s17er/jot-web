 ...
 * @version 1.0
 */
public class DeleteForm extends WebdataForm implements Serializable  {

	/** シリアルバージョンUID */
	private static final long serialVersionUID = 7893690721541891449L;
...
//		magazineFlg = null;
		...
		Beans.copy(new DeleteForm(), this).excludes("id", "processFlg", "version").execute();
	}
}
