package com.gourmetcaree.admin.pc.preview.form.detailPreview;
 ...
 * @version 1.0
 */
public class DetailForm extends PreviewBaseForm implements CheckStatusChangeAccessor {

	/** シリアルバージョンUID */
	private static final long serialVersionUID = -3606564643489607837L;

	/** 登録、COPY画面から来た場合のWebId */
	private static final String NOT_REGISTERED_INPUT_WEB_ID = "0";
	...
	/** チェック済みボタンを表示するか */
	private boolean isChangeableCheckStatus = false;
...
//    			isTrue(imageCheckMap.get(MaterialKbn.SUB_2))
//    		||
...
//    			|| sizeKbn == SizeKbn.F
	...
	public String getIdForDirName() {
		return (StringUtils.isNotBlank(id) && !NOT_REGISTERED_INPUT_WEB_ID.equals(id)) ?
				id : GourmetCareeConstants.IMG_FILEKEY_INPUT;
	}
     ...
     * チェック済みボタンを表示するか
     */
    public boolean isChangeableCheckStatus() {
		return isChangeableCheckStatus;
	}

    /*
     * (non-Javadoc)
     * @see com.gourmetcaree.admin.service.accessor.preview.CheckStatusChangeAccessor#getId()
     */
    @Override
    public String getId() {
    	return id;
    ...
    /*
     * (non-Javadoc)
     * @see com.gourmetcaree.admin.service.accessor.preview.CheckStatusChangeAccessor#setChangeableCheckStatus(boolean)
     */
    @Override
    public void setChangeableCheckStatus(boolean isChangeableCheckStatus) {
		this.isChangeableCheckStatus = isChangeableCheckStatus;
	}
